...
import {CLOSE_ANIM_DURATION, OPEN_ANIM_DURATION} from "react-native-popup-menu/src/constants";
...
const computePosition = ({windowLayout, triggerLayout, optionsLayout}, isRTL) => {
    ...
    const top = axisPosition(oHeight, wHeight, tY - wY, tHeight) + 46;
    const left = axisPosition(oWidth, wWidth, tX - wX, tWidth) - 10;
